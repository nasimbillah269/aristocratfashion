                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="form-control" name="location">
                                            ...
                                            <option value="Interior Service Gallery" {{$gallery->location=='Interior Service Gallery'?'selected':''}}>Interior Service Gallery</option>
                                            <option value="Interior Project Gallery" {{$gallery->location=='Interior Project Gallery'?'selected':''}}>Interior Project Gallery</option>
                                            <option value="Interior Project Videos Gallery" {{$gallery->location=='Interior Project Videos Gallery'?'selected':''}}>Interior Project Videos Gallery</option>
                                            <option value="Interior Muse Design Portfolio Gallery" {{$gallery->location=='Interior Muse Design Portfolio Gallery'?'selected':''}}>Interior Muse Design Portfolio Gallery</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-3">
