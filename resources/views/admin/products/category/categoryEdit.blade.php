                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('slug')?'error':''}}" name="slug" placeholder="Enter Category slug" value="{{$category->slug?:old('slug')}}"  />
                                    @if ($errors->has('slug'))
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="banner">Category Hover Image (Size: 400X400)</label>
