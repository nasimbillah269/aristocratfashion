                    ...
                    <div class="invoiceContainer">
	                    <div class="invoice-inner InnerInvoiePage" >
                			<div class="invoice-header">
                				<div class="row">
                					<div class="col-4">
                						<img src="{{asset(general()->logo())}}" style="max-width: 120px;">
                					</div>
                					<div class="col-1"></div>
                				...
                				<div class="row" style="flex-wrap: wrap;">
                					<div class="col-3">
                						<p>
											...
											<b>Address:</b> {{ str_replace('Dhaka District, ', '', $order->fullAddress()) }}, Dhaka District
                			...
                			<div class="footerInvoice">
                				<div class="row" style="dispaly:flex;">
                					...
                					<div class="col-5" style="flex: 0 0 46%;max-width: 46%;">
                						<p>Thank you for shopping from {{general()->website}}</p>
                					</div>
                					
                					<div class="col-2">
                					     <img src="{{asset('medies/qr.PNG')}}" style="max-width:80px;margin-top: -30px;">
                					</div>
