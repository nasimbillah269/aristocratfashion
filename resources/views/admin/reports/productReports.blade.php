                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mb-1">
                                                <select name="stock" class="form-control">
                                                    ...
                                                    <option value="stock" {{request()->stock=='In Stock'?'selected':''}} >In Stock</option>
                                                    <option value="out_of_stock" {{request()->stock=='out_of_stock'?'selected':''}} >Out of Stock</option>
                                                    <option value="pre_order" {{request()->stock=='pre_order'?'selected':''}} >Pre Order</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3 mb-1">
                                                <div class="input-group">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataex-html5-export">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{priceFormat($product->quantity)}}</td>
