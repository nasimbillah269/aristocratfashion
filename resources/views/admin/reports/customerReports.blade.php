                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataex-html5-export">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$customers->currentpage()==1?$i+1:$i+($customers->perpage()*($customers->currentpage() - 1))+1}}</td>
                                                <td>{{$customer->name}}</td>
                                                <td>{{$customer->email}}</td>
                                                <td>{{$customer->mobile}}</td>
                                                <td>{{$customer->orders()->where('order_type','customer_order')->count()}}</td>
                                                <td>{{priceFullFormat($customer->orders()->where('order_type','customer_order')->sum('grand_total'))}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
