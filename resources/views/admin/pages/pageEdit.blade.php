                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="template">
                                        ...
                                        <option value="New Arrival" {{$page->template=='New Arrival'?'selected':''}}>New Arrival</option>
                                        <option value="Top Sell" {{$page->template=='Top Sell'?'selected':''}}>Top Sell</option>
                                        <option value="Payment Method" {{$page->template=='Payment Method'?'selected':''}}>Payment Method</option>
                                    </select>
