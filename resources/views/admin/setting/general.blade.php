    ...
    <div class="card-content">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    <label for="helpInputTop">Logo (500px X 120px)</label>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    <label for="helpInputTop">Footer Logo (500px X 120px)</label>
                    <input type="file" name="footer_logo" class="form-control {{$errors->has('footer_logo')?'error':''}}" />
                    @if ($errors->has('footer_logo'))
                    <p style="color: red; margin: 0;">{{ $errors->first('footer_logo') }}</p>
                    @endif
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    <img src="{{asset($general->footerLogo())}}" style="max-width: 150px;" />
                    @isset(json_decode(Auth::user()->permission->permission, true)['appsSetting']['general']) @if($general->footer_logo)
                    <a href="{{route('admin.setting','footer_logo')}}" style="color: red;" onclick="return confirm('Are You Want To Delete?')"><i class="fa fa-trash"></i></a>
                    @endif @endisset
                </div>
