<div class="blog-sidebar">
	...
	<div class="mb-4 widget_categories">
		...
		<li><a href="{{route('blogCategory',$ctg->slug?:'no-title')}}" style="color: #0ba36c;">{{$ctg->name}} ({{$ctg->activePosts()->count()}})</a></li>
		@endforeach
		</ul>
	</div>
	<hr>
			...
			<div class="row g-0 m-0">
				...
				<div class="col-md-8 p-0">
    				<div class="card-body" style="padding:5px 10px;">
    					<a href="{{route('blogView',$lPost->slug?:'no-title')}}" style="height: 40px;display: block;overflow: hidden;line-height: 18px;color: black;">{{$lPost->name}}</a>
